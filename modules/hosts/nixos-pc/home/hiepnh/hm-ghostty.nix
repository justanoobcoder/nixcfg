{
  flake.homeModules.hmGhostty = { config, ... }: {
    programs.ghostty = {
      enable = true;
      systemd.enable = true;
      settings = {
        ...
        custom-shader = "${config.home.homeDirectory}/.config/ghostty/cursor_shader.glsl";
        keybind = [
    ...
    home.file.".config/ghostty/cursor_shader.glsl".text = ''
